...
export default class menu extends Phaser.Scene {
  ...
  createAchievementsButton() {
    this.achievements_button = helper
      .createButton(
        this,
        0,
        0,
        ...
        async () => {
          const text = this.add
            .text(
              this.achievements_button.x,
              this.achievements_button.y,
  ...
  async restoreProgress() {
    ...
    window.progress.levels_scores = await GET_ACCOUNT_SCORES({
